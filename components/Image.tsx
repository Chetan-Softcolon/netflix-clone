...
const images = [
  ...
  "https://plus.unsplash.com/premium_photo-1700070725852-dcec2c212a74?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      ...
      <div className="flex justify-between w-full flex-wrap">
        {images &&
          ...
          images?.map((image, index) => (
            <div
              className="group rounded-lg border flex justify-between w-1/3 flex-wrap border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30 image-zoom"
              key={index}
            >
              <img
                className="image-zoom flex rounded-md justify-between w-full"
                src={image}
                alt="image"
              />
            </div>
